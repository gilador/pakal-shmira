...
var L;
async function T() {
  if (!g || (z = (await import("./node_url-TF2A7IZV.js")).default, H = await import("./node_fs-C46QULBS.js"), L = await import("./promises-6PR2Y2XY.js"), V = (await import("./node_vm-42V23E6B.js")).default, D = await import("./node_path-SLPWHF6G.js"), U = D.sep, typeof R < "u")) return;
  let e = H, t = await import("./node_crypto-JHBAYUO3.js"), o = await import("./ws-KQ7UAJAF.js"), r = await import("./node_child_process-RGUQMCKE.js"), a = { fs: e, crypto: t, ws: o, child_process: r };
...
async function K() {
  ...
  if (g && !t.startsWith("file://") && (t = `file://${t}`), W) {
    let r = await import("./node_path-SLPWHF6G.js");
    return (await import("./node_url-TF2A7IZV.js")).fileURLToPath(r.dirname(t));
  }
